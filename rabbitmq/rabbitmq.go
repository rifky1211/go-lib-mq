...
func (c *Client) Publish(ctx context.Context, exchange, queue string, data interface{}, durable bool) error {
	...
	err = ch.Publish(exchange, q.Name, false, false, amqp.Publishing{
